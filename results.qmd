...
To build on the borough-level insights, the precinct-level analysis provides a finer-grained view of arrest distributions across New York City.
...
boroughs <- st_read("new-york-city-boroughs.geojson")
precincts <- st_read("Police Precincts.geojson")
...
pal <- colorNumeric(palette = rev(viridis::viridis_pal()(256)),
